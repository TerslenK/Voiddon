...
group = "io.github.teslenk.voiddon" // TODO: Change this to your group
...
addon {
    ...
    main.set("io.github.terslenk.voiddon.Voiddon") // TODO: Change this to your main class
    authors.add("TerslenK") // TODO: Set your list of authors
}
